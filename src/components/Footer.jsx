...
export default function Footer(props){
    return (
        <footer className={`mt-20 h-28 border-t-2 border-solid ${props.isDarkMode ? "border-slate-700" : ""} flex items-center justify-center space-x-8`}>
            <h1 className="text-lg font-Open_Sans">© 2023 Dospinescu Daniel</h1>
