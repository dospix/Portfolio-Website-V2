...
export default function Footer(props){
    return (
        <footer className={`2xl:mt-20 lg:mt-8 2xl:h-28 lg:h-16 border-t-2 border-solid ${props.isDarkMode ? "border-slate-700" : ""} flex items-center justify-center space-x-8`}>
